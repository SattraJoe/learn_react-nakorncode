...
function RouteComponent() {
  ...
  // The way React normally works
  function reactAddNumber() {
    setNumbers1([...numbers1, numbers1.length + 1])
  }
 
  // The way Immer helps reduce complexity
  ...
  // The way useImmer() helps reduce complexity (must be used instead of useState())
  ...
  const reactOnChangeCountry: InputHTMLAttributes<HTMLInputElement>['onChange'] = (event) => {
    ...
    // setPerson1({ ...person1, location: { province: person1.location.province, country: event.target.value } })
  }
