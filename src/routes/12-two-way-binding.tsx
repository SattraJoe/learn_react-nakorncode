  ...
  return (
    <>
      ...
      <div className="space-y-1">
        ...
        <button type="button" onClick={setDataDefault} className="bg-gray-600 hover:bg-gray-700 text-white py-1 px-3 rounded cursor-pointer">Set data as default</button>
      </div>
    </>
  )
}
